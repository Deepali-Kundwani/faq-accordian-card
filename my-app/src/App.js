...
export default function App() {
  ...
  <img className="mobile-bg-image" src="./images/bg-pattern-mobile.svg" width="100%" height="100"/>
  <img className="mobile-illustration" src="./images/illustration-woman-online-mobile.svg" width="100%" height="100"/>
